...
[Documentation](https://github.com/dialogic-godot/dialogic-1/blob/main/addons/dialogic/Documentation/Content/Welcome.md) -
[Credits](#credits)
...
## 📚 Documentation
You can check the documentation from inside the plugin or [here](https://github.com/dialogic-godot/dialogic-1/blob/main/addons/dialogic/Documentation/Content/Welcome.md))

## Installation

To install a Dialogic, download it as a ZIP archive. The latest release is listed here: [releases](https://github.com/dialogic-godot/dialogic/releases/tag/v1.5.1). Then extract the ZIP archive and move the `addons/` folder it contains into your project folder. Then, enable the plugin in project settings.
